const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ActionView-Dmd4Wdu6.js","assets/ActionView-ugz4nsF4.css","assets/AdminView-Dw8sIV0w.js","assets/AdminView-BxCgHhPk.css","assets/DocView-eDA_tgTe.js","assets/DocView-JHBvaCaX.css","assets/JoinUsView-DFTwyal2.js","assets/JoinUsView-69UeaZhz.css","assets/ChangeLogView-ozNs3WG_.js","assets/ChangeLogView-BvE15HZA.css","assets/MapsView-CJnf20aB.js","assets/leaflet-src-BM_x6XIT.js","assets/leaflet-src-HupOsEJb.css","assets/Loader-BRU9Q34W.js","assets/Loader-D04Knui3.css","assets/mix-O88PJOmL.js","assets/MapsView-BZlJAW8u.css","assets/FlagView-DJTkb5tZ.js","assets/Card-Bh2eNQok.js","assets/Card-BUJkKdzi.css","assets/FlagView-BdJvIrvN.css","assets/ProfileView-G17q7HIq.js","assets/ProfileView-Kgc4-67G.css","assets/PrivacyPolicyView-CuHyPW_m.js","assets/PrivacyPolicyView-CBD_1jnB.css","assets/FeedbackView-BKClFPfp.js","assets/FeedbackView-DR4UgRx8.css","assets/FaqView-DC3AfqnV.js","assets/FaqView-BGOxJ8aB.css","assets/CreateFaqView-DPTDU9kO.js","assets/CreateFaqView-_Khm9L0Y.css","assets/EditFaqView-Dps37I5S.js","assets/EditFaqView-BijKtgWG.css","assets/AboutView-C67rv3j_.js","assets/AboutView-B0xuRFU5.css","assets/404ErrorView-CL9UyUM1.js","assets/404ErrorView-DOV6fQwr.css"])))=>i.map(i=>d[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Br(t){return JSON.parse(t)}function Se(t){return JSON.stringify(t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xp=function(t){let e={},n={},s={},r="";try{const i=t.split(".");e=Br(so(i[0])||""),n=Br(so(i[1])||""),r=i[2],s=n.d||{},delete n.d}catch{}return{header:e,claims:n,data:s,signature:r}},aw=function(t){const e=Xp(t),n=e.claims;return!!n&&typeof n=="object"&&n.hasOwnProperty("iat")},lw=function(t){const e=Xp(t).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hE="firebase-heartbeat-database",fE=1,jr="firebase-heartbeat-store";let Da=null;function sg(){return Da||(Da=Ow(hE,fE,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(jr)}catch(n){console.warn(n)}}}}).catch(t=>{throw Tn.create("idb-open",{originalErrorMessage:t.message})})),Da}async function pE(t){try{const n=(await sg()).transaction(jr),s=await n.objectStore(jr).get(rg(t));return await n.done,s}catch(e){if(e instanceof xn)Zt.warn(e.message);else{const n=Tn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Zt.warn(n.message)}}}async function _d(t,e){try{const s=(await sg()).transaction(jr,"readwrite");await s.objectStore(jr).put(e,rg(t)),await s.done}catch(n){if(n instanceof xn)Zt.warn(n.message);else{const s=Tn.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Zt.warn(s.message)}}}function rg(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ug(t){return{type:"value",snapshotNode:t}}function Ds(t,e){return{type:"child_added",snapshotNode:e,childName:t}}function Vr(t,e){return{type:"child_removed",snapshotNode:e,childName:t}}function Wr(t,e,n){return{type:"child_changed",snapshotNode:e,childName:t,oldSnap:n}}function NC(t,e){return{type:"child_moved",snapshotNode:e,childName:t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nc{constructor(e){this.index_=e}updateChild(e,n,s,r,i,o){P(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(n);return a.getChild(r).equals(s.getChild(r))&&a.isEmpty()===s.isEmpty()||(o!=null&&(s.isEmpty()?e.hasChild(n)?o.trackChildChange(Vr(n,a)):P(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(Ds(n,s)):o.trackChildChange(Wr(n,s,a))),e.isLeafNode()&&s.isEmpty())?e:e.updateImmediateChild(n,s).withIndex(this.index_)}updateFullNode(e,n,s){return s!=null&&(e.isLeafNode()||e.forEachChild(Ee,(r,i)=>{n.hasChild(r)||s.trackChildChange(Vr(r,i))}),n.isLeafNode()||n.forEachChild(Ee,(r,i)=>{if(e.hasChild(r)){const o=e.getImmediateChild(r);o.equals(i)||s.trackChildChange(Wr(r,i,o))}else s.trackChildChange(Ds(r,i))})),n.withIndex(this.index_)}updatePriority(e,n){return e.isEmpty()?V.EMPTY_NODE:e.updatePriority(n)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kC{constructor(e){this.withinDirectionalStart=n=>this.reverse_?this.withinEndPost(n):this.withinStartPost(n),this.withinDirectionalEnd=n=>this.reverse_?this.withinStartPost(n):this.withinEndPost(n),this.withinStartPost=n=>{const s=this.index_.compare(this.rangedFilter_.getStartPost(),n);return this.startIsInclusive_?s<=0:s<0},this.withinEndPost=n=>{const s=this.index_.compare(n,this.rangedFilter_.getEndPost());return this.endIsInclusive_?s<=0:s<0},this.rangedFilter_=new qr(e),this.index_=e.getIndex(),this.limit_=e.getLimit(),this.reverse_=!e.isViewFromLeft(),this.startIsInclusive_=!e.startAfterSet_,this.endIsInclusive_=!e.endBeforeSet_}updateChild(e,n,s,r,i,o){return this.rangedFilter_.matches(new Y(n,s))||(s=V.EMPTY_NODE),e.getImmediateChild(n).equals(s)?e:e.numChildren()<this.limit_?this.rangedFilter_.getIndexedFilter().updateChild(e,n,s,r,i,o):this.fullLimitUpdateChild_(e,n,s,i,o)}updateFullNode(e,n,s){let r;if(n.isLeafNode()||n.isEmpty())r=V.EMPTY_NODE.withIndex(this.index_);else if(this.limit_*2<n.numChildren()&&n.isIndexed(this.index_)){r=V.EMPTY_NODE.withIndex(this.index_);let i;this.reverse_?i=n.getReverseIteratorFrom(this.rangedFilter_.getEndPost(),this.index_):i=n.getIteratorFrom(this.rangedFilter_.getStartPost(),this.index_);let o=0;for(;i.hasNext()&&o<this.limit_;){const a=i.getNext();if(this.withinDirectionalStart(a))if(this.withinDirectionalEnd(a))r=r.updateImmediateChild(a.name,a.node),o++;else break;else continue}}else{r=n.withIndex(this.index_),r=r.updatePriority(V.EMPTY_NODE);let i;this.reverse_?i=r.getReverseIterator(this.index_):i=r.getIterator(this.index_);let o=0;for(;i.hasNext();){const a=i.getNext();o<this.limit_&&this.withinDirectionalStart(a)&&this.withinDirectionalEnd(a)?o++:r=r.updateImmediateChild(a.name,V.EMPTY_NODE)}}return this.rangedFilter_.getIndexedFilter().updateFullNode(e,r,s)}updatePriority(e,n){return e}filtersNodes(){return!0}getIndexedFilter(){return this.rangedFilter_.getIndexedFilter()}getIndex(){return this.index_}fullLimitUpdateChild_(e,n,s,r,i){let o;if(this.reverse_){const d=this.index_.getCompare();o=(h,p)=>d(p,h)}else o=this.index_.getCompare();const a=e;P(a.numChildren()===this.limit_,"");const l=new Y(n,s),c=this.reverse_?a.getFirstChild(this.index_):a.getLastChild(this.index_),u=this.rangedFilter_.matches(l);if(a.hasChild(n)){const d=a.getImmediateChild(n);let h=r.getChildAfterChild(this.index_,c,this.reverse_);for(;h!=null&&(h.name===n||a.hasChild(h.name));)h=r.getChildAfterChild(this.index_,h,this.reverse_);const p=h==null?1:o(h,l);if(u&&!s.isEmpty()&&p>=0)return i!=null&&i.trackChildChange(Wr(n,s,d)),a.updateImmediateChild(n,s);{i!=null&&i.trackChildChange(Vr(n,d));const _=a.updateImmediateChild(n,V.EMPTY_NODE);return h!=null&&this.rangedFilter_.matches(h)?(i!=null&&i.trackChildChange(Ds(h.name,h.node)),_.updateImmediateChild(h.name,h.node)):_}}else return s.isEmpty()?e:u&&o(c,l)>=0?(i!=null&&(i.trackChildChange(Vr(c.name,c.node)),i.trackChildChange(Ds(n,s))),a.updateImmediateChild(n,s).updateImmediateChild(c.name,V.EMPTY_NODE)):e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $d=10*1e3,FC=30*1e3,UC=5*60*1e3;class $C{constructor(e,n){this.server_=n,this.statsToReport_={},this.statsListener_=new MC(e);const s=$d+(FC-$d)*Math.random();Ir(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),n={};let s=!1;Xe(e,(r,i)=>{i>0&&sn(this.statsToReport_,r)&&(n[r]=i,s=!0)}),s&&this.server_.reportStats(n),Ir(this.reportStats_.bind(this),Math.floor(Math.random()*2*UC))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gr{constructor(e,n){this.source=e,this.path=n,this.type=yt.LISTEN_COMPLETE}operationForChild(e){return J(this.path)?new Gr(this.source,Z()):new Gr(this.source,ge(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zr{constructor(e,n,s){this.source=e,this.path=n,this.children=s,this.type=yt.MERGE}operationForChild(e){if(J(this.path)){const n=this.children.subtree(new he(e));return n.isEmpty()?null:n.value?new es(this.source,Z(),n.value):new zr(this.source,Z(),n)}else return P(K(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new zr(this.source,ge(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Go(t,e){return{eventCache:t,serverCache:e}}function Ar(t,e,n,s){return Go(new Pn(e,n,s),t.serverCache)}function jg(t,e,n,s){return Go(t.eventCache,new Pn(e,n,s))}function po(t){return t.eventCache.isFullyInitialized()?t.eventCache.getNode():null}function ts(t){return t.serverCache.isFullyInitialized()?t.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let yo;function ST(t){P(!yo,"__referenceConstructor has already been defined"),yo=t}function IT(){return P(yo,"Reference.ts has not been loaded"),yo}let AT=1;class Yd{constructor(e){this.listenProvider_=e,this.syncPointTree_=new ve(null),this.pendingWriteTree_=nT(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function tm(t,e,n,s,r){return qC(t.pendingWriteTree_,e,n,s,r),r?fi(t,new es(Bg(),e,n)):[]}function qn(t,e,n=!1){const s=GC(t.pendingWriteTree_,e);if(zC(t.pendingWriteTree_,e)){let i=new ve(null);return s.snap!=null?i=i.set(Z(),!0):Xe(s.children,o=>{i=i.set(new he(o),!0)}),fi(t,new fo(s.path,i,n))}else return[]}function hi(t,e,n){return fi(t,new es(Dc(),e,n))}function RT(t,e,n){const s=ve.fromObject(n);return fi(t,new zr(Dc(),e,s))}function PT(t,e){return fi(t,new Gr(Dc(),e))}function OT(t,e,n){const s=Bc(t,n);if(s){const r=jc(s),i=r.path,o=r.queryId,a=qe(i,e),l=new Gr(xc(o),a);return Hc(t,i,l)}else return[]}function bo(t,e,n,s,r=!1){const i=e._path,o=t.syncPointTree_.get(i);let a=[];if(o&&(e._queryIdentifier==="default"||em(o,e))){const l=TT(o,e,n,s);ET(o)&&(t.syncPointTree_=t.syncPointTree_.remove(i));const c=l.removed;if(a=l.events,!r){const u=c.findIndex(h=>h._queryParams.loadsAllData())!==-1,d=t.syncPointTree_.findOnPath(i,(h,p)=>On(p));if(u&&!d){const h=t.syncPointTree_.subtree(i);if(!h.isEmpty()){const p=DT(h);for(let m=0;m<p.length;++m){const _=p[m],b=_.query,A=im(t,_);t.listenProvider_.startListening(Pr(b),Kr(t,b),A.hashFn,A.onComplete)}}}!d&&c.length>0&&!s&&(u?t.listenProvider_.stopListening(Pr(e),null):c.forEach(h=>{const p=t.queryToTagMap.get(Yo(h));t.listenProvider_.stopListening(Pr(h),p)}))}xT(t,c)}return a}function nm(t,e,n,s){const r=Bc(t,s);if(r!=null){const i=jc(r),o=i.path,a=i.queryId,l=qe(o,e),c=new es(xc(a),l,n);return Hc(t,o,c)}else return[]}function NT(t,e,n,s){const r=Bc(t,s);if(r){const i=jc(r),o=i.path,a=i.queryId,l=qe(o,e),c=ve.fromObject(n),u=new zr(xc(a),l,c);return Hc(t,o,u)}else return[]}function Al(t,e,n,s=!1){const r=e._path;let i=null,o=!1;t.syncPointTree_.foreachOnPath(r,(h,p)=>{const m=qe(h,r);i=i||An(p,m),o=o||On(p)});let a=t.syncPointTree_.get(r);a?(o=o||On(a),i=i||An(a,Z())):(a=new Jg,t.syncPointTree_=t.syncPointTree_.set(r,a));let l;i!=null?l=!0:(l=!1,i=V.EMPTY_NODE,t.syncPointTree_.subtree(r).foreachChild((p,m)=>{const _=An(m,Z());_&&(i=i.updateImmediateChild(p,_))}));const c=em(a,e);if(!c&&!e._queryParams.loadsAllData()){const h=Yo(e);P(!t.queryToTagMap.has(h),"View does not exist, but we have a tag");const p=LT();t.queryToTagMap.set(h,p),t.tagToQueryMap.set(p,h)}const u=zo(t.pendingWriteTree_,r);let d=CT(a,e,n,u,i,l);if(!c&&!o&&!s){const h=Zg(a,e);d=d.concat(MT(t,e,h))}return d}function $c(t,e,n){const r=t.pendingWriteTree_,i=t.syncPointTree_.findOnPath(e,(o,a)=>{const l=qe(o,e),c=An(a,l);if(c)return c});return Wg(r,e,i,n,!0)}function kT(t,e){const n=e._path;let s=null;t.syncPointTree_.foreachOnPath(n,(c,u)=>{const d=qe(c,n);s=s||An(u,d)});let r=t.syncPointTree_.get(n);r?s=s||An(r,Z()):(r=new Jg,t.syncPointTree_=t.syncPointTree_.set(n,r));const i=s!=null,o=i?new Pn(s,!0,!1):null,a=zo(t.pendingWriteTree_,e._path),l=Qg(r,e,a,i?o.getNode():V.EMPTY_NODE,i);return mT(l)}function fi(t,e){return sm(e,t.syncPointTree_,null,zo(t.pendingWriteTree_,Z()))}function sm(t,e,n,s){if(J(t.path))return rm(t,e,n,s);{const r=e.get(Z());n==null&&r!=null&&(n=An(r,Z()));let i=[];const o=K(t.path),a=t.operationForChild(o),l=e.children.get(o);if(l&&a){const c=n?n.getImmediateChild(o):null,u=qg(s,o);i=i.concat(sm(a,l,c,u))}return r&&(i=i.concat(Uc(r,t,s,n))),i}}function rm(t,e,n,s){const r=e.get(Z());n==null&&r!=null&&(n=An(r,Z()));let i=[];return e.children.inorderTraversal((o,a)=>{const l=n?n.getImmediateChild(o):null,c=qg(s,o),u=t.operationForChild(o);u&&(i=i.concat(rm(u,a,l,c)))}),r&&(i=i.concat(Uc(r,t,s,n))),i}function im(t,e){const n=e.query,s=Kr(t,n);return{hashFn:()=>(gT(e)||V.EMPTY_NODE).hash(),onComplete:r=>{if(r==="ok")return s?OT(t,n._path,s):PT(t,n._path);{const i=kE(r,n);return bo(t,n,null,i)}}}}function Kr(t,e){const n=Yo(e);return t.queryToTagMap.get(n)}function Yo(t){return t._path.toString()+"$"+t._queryIdentifier}function Bc(t,e){return t.tagToQueryMap.get(e)}function jc(t){const e=t.indexOf("$");return P(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new he(t.substr(0,e))}}function Hc(t,e,n){const s=t.syncPointTree_.get(e);P(s,"Missing sync point for query tag that we're tracking");const r=zo(t.pendingWriteTree_,e);return Uc(s,n,r,null)}function DT(t){return t.fold((e,n,s)=>{if(n&&On(n))return[Ko(n)];{let r=[];return n&&(r=Xg(n)),Xe(s,(i,o)=>{r=r.concat(o)}),r}})}function Pr(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(IT())(t._repo,t._path):t}function xT(t,e){for(let n=0;n<e.length;++n){const s=e[n];if(!s._queryParams.loadsAllData()){const r=Yo(s),i=t.queryToTagMap.get(r);t.queryToTagMap.delete(r),t.tagToQueryMap.delete(i)}}}function LT(){return AT++}function MT(t,e,n){const s=e._path,r=Kr(t,e),i=im(t,n),o=t.listenProvider_.startListening(Pr(e),r,i.hashFn,i.onComplete),a=t.syncPointTree_.subtree(s);if(r)P(!On(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,u,d)=>{if(!J(c)&&u&&On(u))return[Ko(u).query];{let h=[];return u&&(h=h.concat(Xg(u).map(p=>p.query))),Xe(d,(p,m)=>{h=h.concat(m)}),h}});for(let c=0;c<l.length;++c){const u=l[c];t.listenProvider_.stopListening(Pr(u),Kr(t,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eu{constructor(e,n,s,r){this._repo=e,this._path=n,this._queryParams=s,this._orderByCalled=r}get key(){return J(this._path)?null:Pg(this._path)}get ref(){return new rn(this._repo,this._path)}get _queryIdentifier(){const e=Ud(this._queryParams),n=Tc(e);return n==="{}"?"default":n}get _queryObject(){return Ud(this._queryParams)}isEqual(e){if(e=Be(e),!(e instanceof eu))return!1;const n=this._repo===e._repo,s=Rc(this._path,e._path),r=this._queryIdentifier===e._queryIdentifier;return n&&s&&r}toJSON(){return this.toString()}toString(){return this._repo.toString()+uC(this._path)}}class rn extends eu{constructor(e,n){super(e,n,new kc,!1)}get parent(){const e=Ng(this._path);return e===null?null:new rn(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Yr{constructor(e,n,s){this._node=e,this.ref=n,this._index=s}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new he(e),s=Jr(this.ref,e);return new Yr(this._node.getChild(n),s,Ee)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(s,r)=>e(new Yr(r,Jr(this.ref,s),Ee)))}hasChild(e){const n=new he(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function gi(t,e){return t=Be(t),t._checkNotDeleted("ref"),e!==void 0?Jr(t._root,e):t._root}function Jr(t,e){return t=Be(t),K(t._path)===null?zT("child","path",e):fm("child","path",e),new rn(t._repo,Ie(t._path,e))}function OU(t,e){t=Be(t),Yc("push",t._path),hm("push",e,t._path,!0);const n=mm(t._repo),s=fS(n),r=Jr(t,s),i=Jr(t,s);let o;return e!=null?o=tu(i,e).then(()=>i):o=Promise.resolve(i),r.then=o.then.bind(o),r.catch=o.then.bind(o,void 0),r}function NU(t){return Yc("remove",t._path),tu(t,null)}function tu(t,e){t=Be(t),Yc("set",t._path),hm("set",e,t._path,!1);const n=new Vo;return sS(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}function mS(t){t=Be(t);const e=new Cm(()=>{}),n=new ea(e);return nS(t._repo,t,n).then(s=>new Yr(s,new rn(t._repo,t._path),t._queryParams.getIndex()))}class ea{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const s=n._queryParams.getIndex();return new pS("value",this,new Yr(e.snapshotNode,new rn(n._repo,n._path),s))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new gS(this,e,n):null}matches(e){return e instanceof ea?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function _S(t,e,n,s,r){let i;if(typeof s=="object"&&(i=void 0,r=s),typeof s=="function"&&(i=s),r&&r.onlyOnce){const l=n,c=(u,d)=>{Zd(t._repo,t,a),l(u,d)};c.userCallback=n.userCallback,c.context=n.context,n=c}const o=new Cm(n,i||void 0),a=new ea(o);return iS(t._repo,t,a),()=>Zd(t._repo,t,a)}function Pl(t,e,n,s){return _S(t,"value",e,n,s)}bT(rn);ST(rn);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mi{constructor(e,n){this.shortDelay=e,this.longDelay=n,tn(n>e,"Short delay should be less than long delay!"),this.isMobile=yc()||Jp()}get(){return NS()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Qr(t,e,n=!1){if(n)return e;try{return await e}catch(s){throw s instanceof xn&&jS(s)&&t.auth.currentUser===t&&await t.auth.signOut(),s}}function jS({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function pI(t,e){return _i(t,"POST","/v1/accounts:signInWithPassword",on(t,e))}async function qm(t,e){return an(t,"POST","/v1/accounts:sendOobCode",on(t,e))}async function gI(t,e){return qm(t,e)}async function mI(t,e){return qm(t,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _I(t,e){return _i(t,"POST","/v1/accounts:signInWithEmailLink",on(t,e))}async function vI(t,e){return _i(t,"POST","/v1/accounts:signInWithEmailLink",on(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function As(t,e){return _i(t,"POST","/v1/accounts:signInWithIdp",on(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bI(t){switch(t){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function wI(t){const e=gr(mr(t)).link,n=e?gr(mr(e)).deep_link_id:null,s=gr(mr(t)).deep_link_id;return(s?gr(mr(s)).link:null)||s||n||e||t}class lu{constructor(e){var n,s,r,i,o,a;const l=gr(mr(e)),c=(n=l.apiKey)!==null&&n!==void 0?n:null,u=(s=l.oobCode)!==null&&s!==void 0?s:null,d=bI((r=l.mode)!==null&&r!==void 0?r:null);W(c&&u&&d,"argument-error"),this.apiKey=c,this.operation=d,this.code=u,this.continueUrl=(i=l.continueUrl)!==null&&i!==void 0?i:null,this.languageCode=(o=l.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(a=l.tenantId)!==null&&a!==void 0?a:null}static parseLink(e){const n=wI(e);try{return new lu(n)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ws{constructor(){this.providerId=Ws.PROVIDER_ID}static credential(e,n){return Xr._fromEmailAndPassword(e,n)}static credentialWithLink(e,n){const s=lu.parseLink(n);return W(s,"argument-error"),Xr._fromEmailAndCode(e,s.code,s.tenantId)}}Ws.PROVIDER_ID="password";Ws.EMAIL_PASSWORD_SIGN_IN_METHOD="password";Ws.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vi extends Gm{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vn extends vi{constructor(){super("facebook.com")}static credential(e){return ns._fromParams({providerId:vn.PROVIDER_ID,signInMethod:vn.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return vn.credentialFromTaggedObject(e)}static credentialFromError(e){return vn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return vn.credential(e.oauthAccessToken)}catch{return null}}}vn.FACEBOOK_SIGN_IN_METHOD="facebook.com";vn.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bn extends vi{constructor(){super("github.com")}static credential(e){return ns._fromParams({providerId:bn.PROVIDER_ID,signInMethod:bn.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return bn.credentialFromTaggedObject(e)}static credentialFromError(e){return bn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return bn.credential(e.oauthAccessToken)}catch{return null}}}bn.GITHUB_SIGN_IN_METHOD="github.com";bn.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function EI(t,e){return _i(t,"POST","/v1/accounts:signUp",on(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
