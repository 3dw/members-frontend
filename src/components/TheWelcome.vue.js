...
function __VLS_template() {
    ...
    const __VLS_4 = __VLS_pickFunctionalComponentCtx(WelcomeItem, __VLS_1);
    // @ts-ignore
    [WelcomeItem, WelcomeItem,];
    // @ts-ignore
    ...
    const __VLS_14 = __VLS_pickFunctionalComponentCtx(WelcomeItem, __VLS_11);
    // @ts-ignore
    [WelcomeItem, WelcomeItem,];
    // @ts-ignore
    ...
    const __VLS_24 = __VLS_pickFunctionalComponentCtx(WelcomeItem, __VLS_21);
    // @ts-ignore
    [WelcomeItem, WelcomeItem,];
    // @ts-ignore
    ...
    const __VLS_34 = __VLS_pickFunctionalComponentCtx(WelcomeItem, __VLS_31);
    // @ts-ignore
    [WelcomeItem, WelcomeItem,];
    // @ts-ignore
    ...
    const __VLS_44 = __VLS_pickFunctionalComponentCtx(WelcomeItem, __VLS_41);
    var __VLS_slots;
