...
/** @type {__VLS_StyleScopedClasses['donate-heart']} */ ;
/** @type {__VLS_StyleScopedClasses['donate-heart']} */ ;
...
/** @type {__VLS_StyleScopedClasses['card-inputs']} */ ;
/** @type {__VLS_StyleScopedClasses['expiry-inputs']} */ ;
/** @type {__VLS_StyleScopedClasses['expiry-inputs']} */ ;
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
__VLS_asFunctionalDirective(__VLS_directives.vShow)(null, { ...__VLS_directiveBindingRestFields, value: (!__VLS_ctx.showDonationStatus) }, null, null);
__VLS_asFunctionalElement(__VLS_intrinsicElements.h2, __VLS_intrinsicElements.h2)({
    ...{ class: "ui header" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({});
...
for (const [m] of __VLS_getVForSourceType((__VLS_ctx.modes))) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
        ...
        ...{ class: "ui basic green large button" },
        ...{ class: ({ 'active': __VLS_ctx.mode === m }) },
        key: (m),
    });
    (__VLS_ctx.parse(m));
}
__VLS_asFunctionalElement(__VLS_intrinsicElements.img, __VLS_intrinsicElements.img)({
    src: "../assets/donate_heart.webp",
    alt: "捐贈愛心",
    ...{ class: "donate-heart" },
});
if (__VLS_ctx.mode === 'donate-by-card') {
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.select, __VLS_intrinsicElements.select)({
        ...{ onChange: (__VLS_ctx.clearCustomAmount) },
        value: (__VLS_ctx.selectedAmount),
    });
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.input, __VLS_intrinsicElements.input)({
        type: "hidden",
        name: "MerchantID",
        value: (__VLS_ctx.merchantID),
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.input, __VLS_intrinsicElements.input)({
        type: "hidden",
        name: "MerchantTradeNo",
        value: (__VLS_ctx.merchantTradeNo),
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.input, __VLS_intrinsicElements.input)({
        type: "hidden",
        name: "MerchantTradeDate",
        value: (__VLS_ctx.merchantTradeDate),
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.input, __VLS_intrinsicElements.input)({
        type: "hidden",
        name: "PaymentType",
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.input, __VLS_intrinsicElements.input)({
        type: "hidden",
        name: "TotalAmount",
        value: (__VLS_ctx.donationAmount),
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.input, __VLS_intrinsicElements.input)({
        type: "hidden",
        name: "TradeDesc",
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.input, __VLS_intrinsicElements.input)({
        type: "hidden",
        name: "CheckMacValue",
        value: (__VLS_ctx.checkMacValue),
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.input, __VLS_intrinsicElements.input)({
        type: "hidden",
        name: "ClientBackURL",
        value: (__VLS_ctx.clientBackURL),
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
        type: "submit",
        ...{ class: "ui basic green huge active button" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.i, __VLS_intrinsicElements.i)({
        ...{ class: "dollar icon" },
    });
...
if (__VLS_ctx.mode === 'donate-by-qrcode') {
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.img)({
        id: "#donate-qrcode",
        src: "../assets/autolearn_donate_QRCode.png",
        alt: "線上捐款",
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({});
}
...
/** @type {__VLS_StyleScopedClasses['dollar']} */ ;
...
/** @type {__VLS_StyleScopedClasses['stackable']} */ ;
...
/** @type {__VLS_StyleScopedClasses['basic']} */ ;
/** @type {__VLS_StyleScopedClasses['green']} */ ;
/** @type {__VLS_StyleScopedClasses['huge']} */ ;
/** @type {__VLS_StyleScopedClasses['active']} */ ;
/** @type {__VLS_StyleScopedClasses['button']} */ ;
/** @type {__VLS_StyleScopedClasses['dollar']} */ ;
/** @type {__VLS_StyleScopedClasses['icon']} */ ;
