...
main.ui.segment.container
  ...
  .ui.segments
    .ui.segment
      ...
      p 但社經地位低家庭的��子，即使想自學，第一個面對的就是費用問題。
      ...
      .ui.raised.segment
        ...
        .ui.statistics
          ...
          .statistic
            ...
            .label 占教育總支出比例
        br
        p 根據教育部統計，政府在2014年起將高中自學納入政府補助累計嘉惠了8,770名高中自學生，累計支出4億3,850萬元，佔同一時期教育經費總支出7兆2千億��的0.006%，相當於同一時期政府每年花在補助274位國中生的成本。
  ...
  p 民主需要公民的一起關切，請致電或Email教育委員會的立法委員，關切「向下延伸補助國中小自學生」實行細則的擬定進展，並說明為何這項法案對台灣教育的進步致關重要：
  ol
